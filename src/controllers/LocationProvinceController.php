...
/**
 * LocationProvinceController implements the CRUD actions for LocationProvince model.
 */
class LocationProvinceController extends MyController
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * Lists all LocationProvince models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new LocationProvinceSearch();
    ...
    /**
     * Displays a single LocationProvince model.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Creates a new LocationProvince model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new LocationProvince();
    ...
    /**
     * Updates an existing LocationProvince model.
    ...
    /**
     * Deletes an existing LocationProvince model.
    ...
    /**
     * Finds the LocationProvince model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return LocationProvince the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    ...
    {
        if (($model = LocationProvince::findOne($id)) !== null) {
            return $model;
        }
